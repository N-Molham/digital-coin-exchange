...
{
	return DCE_Utiles::sanitize_digit( $target, $negative );
}

function dce_redirect( $target = '', $status = 302 )
{
	DCE_Utiles::redirect( $target, $status );
}
...
class DCE_Utiles
{
	...
	public static function download_headers( $filename )
	{
		// disable caching
