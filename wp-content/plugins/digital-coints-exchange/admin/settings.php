...
function dce_settings_init()
{
	...
	$dce_admin_settings_fields = array (
			...
			array (
					'label' => __( 'Escrow page top message ( Started )', 'dce' ),
					'page' => 'dce_settings_page',
					'section' => 'dce_messages',
					'args' => array (
							'name' => 'escrow_start_top_msg',
							'input' => 'textarea',
							'class' => 'large-text',
							'default' => __( 'Send <strong>%s</strong> to us on this Address : <code>%s</code>', 'dce' ),
							'attrs' => array( 'rows' => '5' ),
							'visible' => true,
							'desc' => __( 'Two parameters will be passed in order: <strong>"amount of coins to send"</strong>, <strong>"receive address"</strong>', 'dce' ),
					),
			),
			array (
					'label' => __( 'Escrow page top message ( In Progress )', 'dce' ),
					'page' => 'dce_settings_page',
					'section' => 'dce_messages',
					'args' => array (
							'name' => 'escrow_progress_top_msg',
							'input' => 'textarea',
							'class' => 'large-text',
							'default' => __( 'Your coins were received, waiting for other party payment', 'dce' ),
							'attrs' => array( 'rows' => '5' ),
							'visible' => true,
							'desc' => '',
					),
			...
			array (
					'label' => __( 'Escrow page top message ( user will be notified when other party sends the coins )', 'dce' ),
					'page' => 'dce_settings_page',
					'section' => 'dce_messages',
					'args' => array (
							'name' => 'escrow_waiting_party_msg',
							'input' => 'textarea',
							'class' => 'large-text',
							'default' => __( 'You will be notified once the other party sends <strong>%s</strong> to us, if for any reason they did not send it on time, you will get your coins back with no commissions.', 'dce' ),
							'attrs' => array( 'rows' => '5' ),
							'visible' => true,
							'desc' => __( 'One parameter will be passed : <strong>"amount of coins to receive from the other party"</strong>', 'dce' ),
					),
			),
			array (
					'label' => __( 'Escrow page top message ( other party sent his coins )', 'dce' ),
					'page' => 'dce_settings_page',
					'section' => 'dce_messages',
					'args' => array (
							'name' => 'escrow_party_sent_msg',
							'input' => 'textarea',
							'class' => 'large-text',
							'default' => __( 'the other party has already sent <strong>%s</strong> on <strong>%s</strong>', 'dce' ),
							'attrs' => array( 'rows' => '5' ),
							'visible' => true,
							'desc' => __( 'Two parameters will be passed in order : <strong>"amount of coins to receive from the other party"</strong>, and <strong>date &amp; time of receiving</strong>', 'dce' ),
					),
			),
			array (
