	...
	$dce_admin_settings_fields = array (
			...
			array (
					...
					'args' => array (
							...
							'attrs' => array( 'rows' => '5' ),
							'visible' => true,
							'desc' => __( 'Three parameters will be passed in order: <strong>"amount of coins to send"</strong>, <strong>"receive address"</strong>, and <strong>"amount of coins to receive from the other party"</strong>', 'dce' ),
					),
			),
			array (
					...
					'args' => array (
							...
							'input' => 'textarea',
							'class' => 'large-text',
							'default' => __( '<p>Your coins where received <strong>%s</strong>' ."\n". '<p>You will be notified once the other party sends <strong>%s</strong> to us, if for any reason they did not send it on time, you will get your coins back with no commissions.</p>', 'dce' ),
							'attrs' => array( 'rows' => '5' ),
							'visible' => true,
							'desc' => __( 'Two parameters will be passed in order: <strong>"amount of coins were sent"</strong>, and <strong>"amount of coins to receive from the other party"</strong>', 'dce' ),
					),
			),
			array (
